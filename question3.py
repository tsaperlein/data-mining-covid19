...
plt.savefig("q3/positivity_rate_current_future.png", bbox_inches="tight")
plt.close()
# --------------------------------------------------------------------------------------------------------------------
...
predictions.to_csv("q3/predictions.csv", index=False)
...
plt.savefig("q3/predictions.png", bbox_inches="tight")
plt.close()
# --------------------------------------------------------------------------------------------------------------------
